        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TimeZoneId = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false, defaultValue: "Europe/Istanbul")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_StaffMemberId_StartsAtUtc_EndsAtUtc",
                table: "Appointments",
                columns: new[] { "StaffMemberId", "StartsAtUtc", "EndsAtUtc" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BusinessServices_BusinessId_IsActive",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StaffMembers_BusinessId_UserId",
                table: "StaffMembers",
